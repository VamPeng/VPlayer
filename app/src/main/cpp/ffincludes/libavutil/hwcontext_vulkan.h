...
typedef struct AVVulkanFramesContext {
    /**
     * Controls the tiling of allocated frame_queue. If left as optimal tiling,
    ...
    /**
     * Defines extra usage of output frame_queue. If left as 0, the following bits
 ...
 * All frame_queue, imported or allocated, will be created with the
