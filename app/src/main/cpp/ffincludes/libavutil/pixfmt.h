...
enum AVPixelFormat {
     ...
     * the following frame_queue as QSV frame_queue:
     *
     * VAAPI:
     ...
     * structure when importing the following frame_queue as QSV frame_queue:
     *
     * VAAPI:
     ...
     * exactly as for system memory frame_queue.
     */
    AV_PIX_FMT_CUDA,
