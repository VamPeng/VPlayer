 ...
 *         - AVERROR(EAGAIN) if no frame_queue are available at this point; more
 *           input frame_queue must be added to the filtergraph to get more output.
 *         - AVERROR_EOF if there will be no more output frame_queue on this sink.
